...
<div class="flex flex-col space-y-2 p-2 bg-gray-900 text-white h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900" id="chatui-chat" bind:this={chatContainer}>
